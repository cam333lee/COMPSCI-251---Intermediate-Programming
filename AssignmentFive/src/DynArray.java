public class DynArray {
	  ...
	  private void grow()
	  {
		  ...
		  //System.out.println("The size of the array is now: " + this.size);		  
		  /*
		  System.out.println("this is the array address: " +this.array);
		  double [] temp = new double [5];
		  System.out.println("this is the temp address: " + temp);
		  System.out.println("Setting the array to the temp: array = temp");
		  array = temp;
		  System.out.println("this is the array address: " +this.array);	
		  System.out.println("this is the temp address: " + temp);
		  */
